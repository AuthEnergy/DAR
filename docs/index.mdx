...
<Warning>
  **This is a design proposal for review and not yet a completed and implementable service.**<p/>
  ...
  Visit the [Github repo](https://github.com/AuthEnergy/dar) to access documentation and fully working demo of the service (but there's likely many bugs). Get in touch if you'd like to contribute.
</Warning>
