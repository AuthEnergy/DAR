...
icon: shield
---
<sub>First published: 15 April 2026 · Status: `DRAFT`</sub>
<Warning>The challenge of tracking which 'down stream' organisations have access to your data is a real one. It's not just about technical systems and legal basis but visibility of who else maybe accessing your data beyond the organisation that you permitted. This document describes one way of tracking this</Warning>
