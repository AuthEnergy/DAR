...
<Warning>
The Customer Consent Portal is an implemented and fully operational component of the Data Access Register. This document describes the proposed design for review and feedback. It can suppliment or replace the Data User in-app presentation of access records via [List Access Records](/api-reference/data-users/list-access-records-for-a-meter-point) which is limited to only that Data Users records.

Key design principles:

- The portal is operated by the Central Register, not by individual Data Users but can be operated by any [authorised portal operator](/data-access-register/portal-operators)
...
- All consent management actions taken in the portal are reflected immediately in the register, Data Users are notified via webhooks directly
