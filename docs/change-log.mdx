...
<Note>Version 0.0.12 has introduced some significant refactoring of how customer identify themselves, this allows customers to now independantly authenticate themselves to the central portal to further strengthen privacy. This also allows the introduction of independant identity verification provision which user can rely on and re-use using the customer independant authentication.</Note>
